...
def train_model(X_train,y_train,X_val, y_val, dv):
    ...
    with mlflow.start_run():
        ...
        with open("03-worflow_orchestration/models/preprocessor.b", "wb") as f_out:
            pickle.dump(dv, f_out)
        mlflow.log_artifact("worflow_orchestration/models/preprocessor.b", artifact_path="preprocessor")
